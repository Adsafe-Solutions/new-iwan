/* =========================================================
   ...
   Rendered as an initials circle — no photos.

   Format: { initials, name, role }
========================================================= */

export const ADVISORS = [
  { initials: "YR", name: "Dr. Yusuf Rahman", role: "Scholar & Social Justice Advocate" },
  { initials: "AK", name: "Aishan Karim", role: "Researcher & Author" },
  { initials: "IM", name: "Sheikh Ibrahim Mansoor", role: "Islamic Scholar" },
  { initials: "ZH", name: "Zainab Hussain", role: "Researcher & Author" },
];
